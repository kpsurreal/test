...
function IndependentWholePosition() {
  ...
  this.checkStockData = function (stock) {
    return stock.hasOwnProperty('total_assets') && stock.hasOwnProperty('stock_code') && stock.hasOwnProperty('price') && stock.hasOwnProperty('dstNum') && stock.hasOwnProperty('security') && stock.hasOwnProperty('net_value');
  };
  this.checkRulesData = function (rules) {
  ...
  this.doCheck = function (stock, rules) {
    ...
    rtnArr.forEach(function (obj) {
      ...
      Object.assign(obj, _this2.compareReturn({
        dstNum: dstNum,
        freeNum: freeNum,
...
function IndependentOnePosition() {
  ...
  this.checkStockData = function (stock) {
    return stock.hasOwnProperty('stock_code') && stock.hasOwnProperty('stock_name') && stock.hasOwnProperty('total_assets') && stock.hasOwnProperty('price') && stock.hasOwnProperty('dstNum') && stock.hasOwnProperty('market_value');
  };
  this.checkRulesData = function (rules) {
  ...
  this.doCheck = function (stock, rules) {
    ...
    rtnArr.forEach(function (obj) {
      ...
      Object.assign(obj, _this3.compareReturn({
        dstNum: dstNum,
        freeNum: freeNum,
        limitAction: limitAction
      }));
...
function IndependentTarget() {
  ...
  this.doCheck = function (stock, rules) {
    ...
    rtnArr.forEach(function (obj) {
      ...
      Object.assign(obj, _this4.compareReturn({
        dstNum: dstNum,
        freeNum: freeNum,
        limitAction: limitAction
      }));
...
function IndependentPlacards() {
  ...
  this.doCheck = function (stock, rules) {
    ...
    rtnArr.forEach(function (obj) {
      ...
      Object.assign(obj, _this5.compareReturn({
        dstNum: dstNum,
        freeNum: freeNum,
        limitAction: limitAction
      }));
...
function IndependentControTrade() {
  ...
  this.doCheck = function (stock, rules) {
    ...
    rtnArr.forEach(function (obj) {
      ...
      Object.assign(obj, _this6.compareReturn({
        dstNum: dstNum,
        freeNum: freeNum,
        limitAction: limitAction
      }));
...
function UnionPlacards() {
  ...
  this.doCheck = function (stock, rules) {
    ...
    rtnArr.forEach(function (obj) {
      ...
      Object.assign(obj, _this7.compareReturn({
        dstNum: dstNum,
        freeNum: freeNum,
        limitAction: limitAction
      }));
...
function UnionControTrade() {
  ...
  this.doCheck = function (stock, rules) {
    ...
    rtnArr.forEach(function (obj) {
      ...
      Object.assign(obj, _this8.compareReturn({
        dstNum: dstNum,
        freeNum: freeNum,
        limitAction: limitAction
      }));
...
//# sourceMappingURL=risk_rules.js.map
