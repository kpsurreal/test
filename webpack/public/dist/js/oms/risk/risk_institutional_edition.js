    ...
    riskVue = new Vue({
      ...
      methods: {
        doSaveTpl: function doSaveTpl() {
          ...
          var product_id = Vue.independentSelected;
          $.startLoading('正在保存...');
          $.ajax({
        ...
        prepareDisplay: function prepareDisplay() {
          ...
          Object.keys(this.totals).forEach(function (e) {
            ...
            if (_this3.productSelected.some(function (el) {
              return el == e;
            }) && (someFlag || _this3.warnSelected.length == 0)) {
...
//# sourceMappingURL=risk_institutional_edition.js.map
