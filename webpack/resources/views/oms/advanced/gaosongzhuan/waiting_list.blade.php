<section class="order-list gaosongzhuan advanced wait">
    <div class="hd">
        <span class="section-title">未处理任务</span>
        ...
        <span class="order-list-ctrls right list-ctrls" style="display:none;">
            <a data-uri="{{ config('view.path_prefix','') }}/oms/advanced/get_gaosongzhuan_list?type=wait" class="active" href="javascript:;"></a>
        </span>
    </div>
    ...
    <table class="oms-table loading-loading nothing-nothing">
        <tr class="hd">
            ...
            <th class="cell-right">公告发布日</th>
            <th class="cell-right">股权登记日</th>
            <th class="cell-right">除权派息日</th>
            <th class="cell-right">派现日</th>
            <th class="cell-right">红股上市日</th>
        ...
        <script type="text/html" row-tpl >
            <tr row >
                ...
                <td class="cell-right" data-src="position_amount|numeral:0,0"></td>
                ...
                <td class="cell-right" data-src="publish_data|moment:MM/DD"></td>
                <td class="cell-right" data-src="record_date|moment:MM/DD"></td>
                <td class="cell-right" data-src="ex_div_date|moment:MM/DD"></td>
                <td class="cell-right" data-src="pay_cash_date|moment:MM/DD"></td>
                <td class="cell-right" data-src="bonus_share_list_date|moment:MM/DD"></td>

                <td class="cell-right" class="cell-right" style="width:75px;">
                    <a class="open-detail oms-btn sm yellow open-detail" href="javascript:;">处理</a>
                </td>
            </tr>
        </script>
    </table>
