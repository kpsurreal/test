...
<section class="order-list report assets">
    ...
    <div class="hd">
        ...
        <a class="right oms-btn gray download-excel" data-text="EXCEL" data-href="{{ config('view.path_prefix','') }}/oms/report/{{ $product_id }}/output/entrust?output=excel"
            style="width:auto;"
        >下载EXCEL</a>
        <a class="right oms-btn gray download-pdf" data-text="PDF" data-href="{{ config('view.path_prefix','') }}/oms/report/{{ $product_id }}/output/entrust?output=pdf"
            style="width:auto;"
        >下载PDF</a>
        ...
        <span class="order-list-ctrls right list-ctrls" style="display:none;">
            {{-- 下面的 url 是一个示例 --}}
            <a data-uri="{{ config('view.path_prefix','') }}/oms/report/${product_id}/output/entrust?" class="active" href="javascript:;"></a>
        </span>
    </div>
