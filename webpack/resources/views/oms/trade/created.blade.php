...
@section('content')
    ...
    {{-- <div class="new-oms-container">
        ...
        <div class="main-container">
            @include('oms.allocation.head',['is_creator'=>true])
            @include('oms.allocation.list_allocated_today',['is_creator'=>true])
            @include('oms.allocation.list_allocated_doned',['is_creator'=>true])
