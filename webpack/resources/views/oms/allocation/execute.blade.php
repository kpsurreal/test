...
@section('content')
    ...
    @include('oms.order_detail.allocation_execute')

    {{-- <div class="new-oms-container">
        @include('common.sub_side_nav') --}}
        <div class="main-container">
            @include('oms.allocation.head',['is_executor'=>true])
            @include('oms.allocation.list_allocated_today',['is_executor'=>true])
            @include('oms.allocation.list_allocated_doned',['is_executor'=>true])
