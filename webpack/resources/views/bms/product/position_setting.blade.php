...
@section('js-private')
    ...
    <script src="{{ asset('/dist/js/product/position_setting.js') }}" type="text/javascript"></script>
    ...
    <script>
        ...
        $(function(){
            $.ajax({
                url: window.REQUEST_PREFIX + '/html/product/position_setting.html',
                type: 'get',
                success: function(data){
                    $('.section-container').html(data);
                    JS_position_setting(window.REQUEST_PREFIX);
                },
                error: function(){
