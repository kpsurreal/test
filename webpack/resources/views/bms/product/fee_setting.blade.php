...
@section('js-private')
    ...
    <script src="{{ asset('/dist/js/product/fee_setting.js') }}" type="text/javascript"></script>
    ...
    <script>
        ...
        $(function(){
            $.ajax({
                url: window.REQUEST_PREFIX + '/html/product/fee_setting.html',
                type: 'get',
                success: function(data){
                    $('.section-container').html(data);
                    JS_fee_setting(window.REQUEST_PREFIX);
                },
                error: function(){
